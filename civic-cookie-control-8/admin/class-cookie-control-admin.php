...
class CCC_Cookie_Control_Admin
{
    ...
    public function ccc_enqueue_styles()
    {
        ...
        wp_enqueue_style('cookie-controljquery-ui-css', plugin_dir_url(__FILE__) . 'css/cookie-control-jquery-ui.css', array(), $this->version, 'all');
    ...
    public function ccc_add_action_links($links)
    {
        ...
        */
        ...
        $settings_link = array(
            ...
            '<a href="https://www.civicuk.com/sites/default/files/manuals/Cookie-Control-WP-plugin-Manual-v1.0.pdf" target="_blank">' . __('Manual') . '</a>',
        );
    ...
    public function get_apivesion_dependencies()
    {
    ...
    public function ccc_get_api_civic($server_url, $api_key)
    {
        $ccc_licenses_type = ['CookieControl%20Free', 'CookieControl%20Single-Site', 'CookieControl%20Multi-Site', 'CookieControl%20Custom'];
        $ccc_v = "8";
    ...
    public function ccc_cookiecontrol_settings_defaults()
    {
    ...
    public function ccc_cookiecontrol_settings_init()
    {
    ...
    public function ccc_cookiecontrol_settings_validate()
    {
    ...
    public function ccc_cookiecontrol_settings_update_check()
    {
    ...
    public function ccc_cookiecontrol_args()
    {

        $this->get_apivesion_dependencies()->ccc_cookiecontrol_args();
    }

    public function ccc_unset_fields_v8()
    {
    ...
    public function ccc_unset_fields_v9()
    {
    ...
    private function ccc_verify_form_submission()
    {
        return current_user_can('manage_options') &&
            isset($_POST['_wpnonce']) &&
            wp_verify_nonce($_POST['_wpnonce'], 'civic_cookiecontrol_settings-options');
    }

    public function ccc_options_update()
    {
        if (isset($_POST['cookiecontrol_settings_api_key_version'])) {
            if (!$this->ccc_verify_form_submission()) {
                return;
            }
            $version = sanitize_text_field(wp_unslash($_POST['cookiecontrol_settings_api_key_version']));
            update_option('civic_cookiecontrol_apikey_version', $version);
        }
